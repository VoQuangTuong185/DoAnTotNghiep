...
namespace WebAppAPI
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "DO AN TOT NGHIEP - ADMIN SERVICE - API MANAGEMENT", Version = "v1" });
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                c.SwaggerEndpoint($"{Config.BackEndUrl}/swagger/v1/swagger.json", "DO AN TOT NGHIEP - ADMIN SERVICE - API MANAGEMENT V1");
