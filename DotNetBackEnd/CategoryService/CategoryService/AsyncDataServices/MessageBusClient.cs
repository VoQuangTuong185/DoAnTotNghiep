...
namespace CategoryService.AsyncDataServices
{
    public class MessageBusClient : IMessageBusClient
    {
        ...
        public void PublishNewCategory(CategoryPublishDto categoryPublishDto)
        {
            var message = JsonSerializer.Serialize(categoryPublishDto);
        ...
        public void InactivedCategory(CategoryUpdateDto categoryPublishDto)
        {
            var message = JsonSerializer.Serialize(categoryPublishDto);
        ...
        public void UpdatedCategory(CategoryUpdateDto categoryPublishDto)
        {
            var message = JsonSerializer.Serialize(categoryPublishDto);
